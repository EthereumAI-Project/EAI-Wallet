...
public class SettingsFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        email.setOnPreferenceClickListener(preference -> {
            ...
            mailto.setData(Uri.parse("mailto:contact@ethereumai.io")
                    .buildUpon()
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        if (key.equals("pref_rpcServer")) {
            ...
            NetworkInfo[] networks = ethereumaiNetworkRepository.getAvailableNetworkList();
            for (NetworkInfo networkInfo : networks) {
                if (networkInfo.name.equals(selectedRpcServer)) {
                    ethereumaiNetworkRepository.setDefaultNetworkInfo(networkInfo);
                    return;
                }
            }
        }
    ...
    private void setRpcServerPreferenceData(ListPreference lp) {
        ...
        String currentValue = ethereumaiNetworkRepository.getDefaultNetwork().name;
