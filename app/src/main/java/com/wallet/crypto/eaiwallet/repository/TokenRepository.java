...
public class TokenRepository implements TokenRepositoryType {
    ...
    public TokenRepository(
        ...
        this.ethereumaiNetworkRepository.addOnChangeDefaultNetwork(this::buildWeb3jClient);
        buildWeb3jClient(ethereumaiNetworkRepository.getDefaultNetwork());
    }
    ...
    public Observable<Token[]> fetch(String walletAddress) {
        return Observable.create(e -> {
            NetworkInfo defaultNetwork = ethereumaiNetworkRepository.getDefaultNetwork();
    ...
    public Completable addToken(Wallet wallet, String address, String symbol, int decimals) {
        return tokenLocalSource.put(
                ethereumaiNetworkRepository.getDefaultNetwork(),
                wallet,
                    ...
                    for (TokenInfo tokenInfo : items) {
                        try {
                            tokenLocalSource.put(
                                    ethereumaiNetworkRepository.getDefaultNetwork(), wallet, tokenInfo)
                                    .blockingAwait();
                        } catch (Throwable t) {
