...
import com.wallet.crypto.eaiwallet.ui.barcode.BarcodeCaptureActivity;
import com.wallet.crypto.eaiwallet.util.BalanceUtils;
import com.wallet.crypto.eaiwallet.util.QRURLParser;
import com.wallet.crypto.eaiwallet.viewmodel.SendViewModel;
...
public class SendActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ethereumaiNetworkRepository.getDefaultNetwork().name == C.ETHEREUMAI_NETWORK_NAME) {
            symbol = C.EAI_SYMBOL;
        }
